...
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_pos_test1.png}
  \caption{CCW\_POS\_GOAL\_RUN\_1}
  \label{fig:CCW_POS_GOAL_RUN_1}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_pos_test2.png}
  \caption{CCW\_POS\_GOAL\_RUN\_2}
  \label{fig:CCW_POS_GOAL_RUN_2}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_pos_test3.png}
  \caption{CCW\_POS\_GOAL\_RUN\_3}
  \label{fig:CCW_POS_GOAL_RUN_3}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_pos_test4.png}
  \caption{CCW\_POS\_GOAL\_RUN\_4}
  \label{fig:CCW_POS_GOAL_RUN_4}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_pos_test5.png}
  \caption{CCW\_POS\_GOAL\_RUN\_5}
  \label{fig:CCW_POS_GOAL_RUN_5}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_pos_test6.png}
  \caption{CCW\_POS\_GOAL\_RUN\_6}
  \label{fig:CCW_POS_GOAL_RUN_6}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_pos_test7.png}
  \caption{CCW\_POS\_GOAL\_RUN\_7}
  \label{fig:CCW_POS_GOAL_RUN_7}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_pos_test8.png}
  \caption{CCW\_POS\_GOAL\_RUN\_8}
  \label{fig:CCW_POS_GOAL_RUN_8}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_pos_test9.png}
  \caption{CCW\_POS\_GOAL\_RUN\_9}
  \label{fig:CCW_POS_GOAL_RUN_9}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_pos_test10.png}
  \caption{CCW\_POS\_GOAL\_RUN\_10}
  \label{fig:CCW_POS_GOAL_RUN_10}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_pos_test11.png}
  \caption{CCW\_POS\_GOAL\_RUN\_11}
  \label{fig:CCW_POS_GOAL_RUN_11}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_pos_test12.png}
  \caption{CCW\_POS\_GOAL\_RUN\_12}
  \label{fig:CCW_POS_GOAL_RUN_12}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_pos_test13.png}
  \caption{CCW\_POS\_GOAL\_RUN\_13}
  \label{fig:CCW_POS_GOAL_RUN_13}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_pos_test14.png}
  \caption{CCW\_POS\_GOAL\_RUN\_14}
  \label{fig:CCW_POS_GOAL_RUN_14}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_pos_test15.png}
  \caption{CCW\_POS\_GOAL\_RUN\_15}
  \label{fig:CCW_POS_GOAL_RUN_15}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_pos_test16.png}
  \caption{CCW\_POS\_GOAL\_RUN\_16}
  \label{fig:CCW_POS_GOAL_RUN_16}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_pos_test17.png}
  \caption{CCW\_POS\_GOAL\_RUN\_17}
  \label{fig:CCW_POS_GOAL_RUN_17}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_pos_test18.png}
  \caption{CCW\_POS\_GOAL\_RUN\_18}
  \label{fig:CCW_POS_GOAL_RUN_18}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_pos_test19.png}
  \caption{CCW\_POS\_GOAL\_RUN\_19}
  \label{fig:CCW_POS_GOAL_RUN_19}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_pos_test20.png}
  \caption{CCW\_POS\_GOAL\_RUN\_20}
  \label{fig:CCW_POS_GOAL_RUN_20}
\end{figure}
\subsection{CCW Negative Limit Switch Goal Velocity EFD Data}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_neg_test1.png}
  \caption{CCW\_NEG\_GOAL\_RUN\_1}
  \label{fig:CCW_NEG_GOAL_RUN_1}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_neg_test2.png}
  \caption{CCW\_NEG\_GOAL\_RUN\_2}
  \label{fig:CCW_NEG_GOAL_RUN_2}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_neg_test3.png}
  \caption{CCW\_NEG\_GOAL\_RUN\_3}
  \label{fig:CCW_NEG_GOAL_RUN_3}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_neg_test4.png}
  \caption{CCW\_NEG\_GOAL\_RUN\_4}
  \label{fig:CCW_NEG_GOAL_RUN_4}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_neg_test5.png}
  \caption{CCW\_NEG\_GOAL\_RUN\_5}
  \label{fig:CCW_NEG_GOAL_RUN_5}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_neg_test6.png}
  \caption{CCW\_NEG\_GOAL\_RUN\_6}
  \label{fig:CCW_NEG_GOAL_RUN_6}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_neg_test7.png}
  \caption{CCW\_NEG\_GOAL\_RUN\_7}
  \label{fig:CCW_NEG_GOAL_RUN_7}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_neg_test8.png}
  \caption{CCW\_NEG\_GOAL\_RUN\_8}
  \label{fig:CCW_NEG_GOAL_RUN_8}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_neg_test9.png}
  \caption{CCW\_NEG\_GOAL\_RUN\_9}
  \label{fig:CCW_NEG_GOAL_RUN_9}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_neg_test10.png}
  \caption{CCW\_NEG\_GOAL\_RUN\_10}
  \label{fig:CCW_NEG_GOAL_RUN_10}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_neg_test11.png}
  \caption{CCW\_NEG\_GOAL\_RUN\_11}
  \label{fig:CCW_NEG_GOAL_RUN_11}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_neg_test12.png}
  \caption{CCW\_NEG\_GOAL\_RUN\_12}
  \label{fig:CCW_NEG_GOAL_RUN_12}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_neg_test13.png}
  \caption{CCW\_NEG\_GOAL\_RUN\_13}
  \label{fig:CCW_NEG_GOAL_RUN_13}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_neg_test14.png}
  \caption{CCW\_NEG\_GOAL\_RUN\_14}
  \label{fig:CCW_NEG_GOAL_RUN_14}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_neg_test15.png}
  \caption{CCW\_NEG\_GOAL\_RUN\_15}
  \label{fig:CCW_NEG_GOAL_RUN_15}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_neg_test16.png}
  \caption{CCW\_NEG\_GOAL\_RUN\_16}
  \label{fig:CCW_NEG_GOAL_RUN_16}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_neg_test17.png}
  \caption{CCW\_NEG\_GOAL\_RUN\_17}
  \label{fig:CCW_NEG_GOAL_RUN_17}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_neg_test18.png}
  \caption{CCW\_NEG\_GOAL\_RUN\_18}
  \label{fig:CCW_NEG_GOAL_RUN_18}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_neg_test19.png}
  \caption{CCW\_NEG\_GOAL\_RUN\_19}
  \label{fig:CCW_NEG_GOAL_RUN_19}
\end{figure}
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{media/CCW_goal_speed_neg_test20.png}
  \caption{CCW\_NEG\_GOAL\_RUN\_20}
  \label{fig:CCW_NEG_GOAL_RUN_20}
\end{figure}
